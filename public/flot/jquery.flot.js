...
(function ($) {
  function Plot(placeholder, data_, options_, plugins) {
    ...
    plot.pointOffset = function (point) {
      return {
        left: parseInt(
          axisSpecToRealAxis(point, "xaxis").p2c(+point.x) + plotOffset.left
        ),
        top: parseInt(
          axisSpecToRealAxis(point, "yaxis").p2c(+point.y) + plotOffset.top
        ),
      };
    };
    ...
    function setupGrid() {
      ...
      function measureLabels(axis, axisOptions) {
        ...
        if (axis == axes.xaxis || axis == axes.x2axis) {
          ...
          if (axis.labelWidth == null)
            axis.labelWidth =
              canvasWidth / (axis.ticks.length > 0 ? axis.ticks.length : 1);
      ...
      function setGridSpacing() {
        ...
        if (axes.x2axis.labelHeight > 0)
          plotOffset.top = Math.max(
            maxOutset,
            axes.x2axis.labelHeight + margin
          );
        if (axes.y2axis.labelWidth > 0)
          plotOffset.right = Math.max(
            maxOutset,
    ...
    function insertLabels() {
      ...
      var html = [
        '<div class="tickLabels" style="font-size:smaller;color:' +
          options.grid.color +
          '">',
      ];
