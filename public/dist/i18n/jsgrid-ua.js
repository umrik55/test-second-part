(function (jsGrid) {
  jsGrid.locales.ua = {
    grid: {
      ...
      pagerFormat:
        "Сторінки: {first} {prev} {pages} {next} {last} &nbsp;&nbsp; {pageIndex} з {pageCount}",
      pagePrevText: "<",
      pageNextText: ">",
      pageFirstText: "<<",
      pageLastText: ">>",
    ...
    validators: {
      ...
      rangeLength: {
        message: "Довжина даного значення не діапазоні допустимих значень",
      },
      ...
      range: {
        message: "ВДовжина даного значення не діапазоні допустимих значень",
      },
