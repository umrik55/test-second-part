  ...
  async function sendMail(data) {
    try {
      ...
      let info = await transporter.sendMail({
        ...
        html: data.is_active
          ? `Hello, <b>${data.username}!</b><br><b>Your login:</b> ${data.email}<br><b>Your password:</b> ${data.password}<br><b>Your API-token:</b> ${data.api_token}<br><br>Have some questions? - contact with developer: Dmitry Liamtsev (lyama961@gmail.com)<br>This mail automatic, not answer pls:)`
          : `Hello, <b>${data.username}!</b><br><b>Your auth data has been blocked! Contact with developer: Dmitry Liamtsev (lyama961@gmail.com)<br>This mail automatic, not answer pls:)`, // plain text body
      });
    } catch (e) {
      console.log(e);
    }
